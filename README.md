...
* **Techs:** JavaScript Puro (Vanilla JS), HTML5, CSS3 (Animações de LED com `@keyframes`).

### 📅 [Agenda M-GTR](https://magdiel-dev7.github.io/agenda-m-gtr/)
Sistema de gerenciamento de tempo focado em tarefas com operações completas de CRUD.
...
Estou aberto a oportunidades profissionais como **Desenvolvedor Full Stack Jr.**, projetos freelancers ou conexões para compartilhar experiências em tecnologia.

* **LinkedIn:** [in/magdiel-barbosa](https://www.linkedin.com/in/magdiel-barbosa)
